...
CLASSES = ('__background__',
           'w_y_h', 'w_e_h', 'w_q_h', 'w_z_h',
           'w_l_h', 'w_y_s', 'w_e_s', 'w_q_s',
           'w_z_s',  'w_l_s', 'w_y_n', 'w_e_n', 'w_q_n', 'w_z_n',
           'w_l_n', 'm_y_h', 'm_e_h', 'm_q_h',
           'm_z_h', 'm_l_h', 'm_y_s', 'm_e_s', 'm_q_s', 'm_z_s', 'm_l_s',
            'm_y_n', 'm_e_n', 'm_q_n', 'm_z_n','m_l_n' )
...
if __name__ == '__main__':
    ...
    net.create_architecture(sess, "TEST", 31,
